...
class EmployeeSalaryController extends Controller
{
    ...
    public function store(Request $request, Employee $employee)
    {
        ...
        $request->validate([
            ...
            'effective_from.required' => 'Start Date is required.',
            'effective_from.date' => 'Enter a valid Start Date.',
            'effective_to.required' => 'End Date is required.',
            'effective_to.date' => 'Enter a valid End Date.',
            'effective_to.after_or_equal' => 'End Date must be equal to or after Start Date.',
