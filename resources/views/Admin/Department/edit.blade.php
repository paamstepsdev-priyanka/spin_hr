...
<div class="row">
    <div class="col-12">
        ...
        <form id="department-form" action="{{ route('departments.update', $department->id) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-body-tertiary py-3">
                    <h5 class="mb-0 fw-bold text-body">Edit Department: {{ $department->name }}</h5>
                </div>
                <div class="card-body p-4">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $department->name) }}" placeholder="e.g. Human Resources">
