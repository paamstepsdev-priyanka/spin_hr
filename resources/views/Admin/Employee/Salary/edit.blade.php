...
@section('title', 'Edit Salary - ' . $employee->name)
...
<div class="row">
    <div class="col-12">
        ...
        <form id="salary-form" action="{{ route('employees.salaries.update', [$employee->id, $salary->id]) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-body-tertiary py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h5 class="mb-0 fw-bold text-body">Edit Salary Details</h5>
