...
<div class="row">
    <div class="col-12">
        ...
        <form id="employee-form" action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PUT')
            ...
            <!-- Form Action Buttons -->
            <div class="mb-4">
                <button type="submit" id="btn-save" class="btn btn-primary px-4 fw-semibold">Update Employee</button>
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    let errorMsg = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'An error occurred while updating. Please try again.';
