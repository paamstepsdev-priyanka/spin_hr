...
<div class="row">
    <div class="col-12">
        ...
        <form id="branch-form" action="{{ route('admin.company.branches.update', [$company->id, $branch->id]) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-body-tertiary py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-body">Edit Branch: {{ $branch->name }}</h5>
            ...
            <!-- Form Action Buttons -->
            <div class="mt-3">
                <button type="submit" id="btn-save" class="btn btn-primary">Update Branch</button>
