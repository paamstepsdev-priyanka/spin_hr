    ...
    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body bg-body-tertiary rounded p-3 d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fw-bold text-body">Monthly Attendance Summary View</h4>
                        ...
                        <tbody>
                            @forelse($attendanceMonth->details as $index => $detail)
                                <tr>
                                    ...
                                    <td class="text-center table-info fw-bold text-primary">{{ (float)$detail->net_present }}</td>
                                    <td class="text-center text-primary">{{ (float)$detail->leave_not_deducted }}</td>
