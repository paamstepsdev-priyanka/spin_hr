        ...
        <div class="card border-0 shadow-sm mb-4 no-print">
            <div class="card-body bg-body-tertiary rounded p-3 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('payrolls.salary-slip.pdf', $detail->id) }}" class="btn btn-danger btn-sm fw-semibold" target="_blank">
                        <i class="bi bi-file-earmark-pdf me-1"></i> PDF Download
                    </a>
                    <a href="{{ route('payrolls.show', $detail->payroll_id) }}" class="btn btn-outline-secondary btn-sm fw-semibold">
                        ...
                        <table class="table table-sm table-borderless small mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">₹ {{ number_format($detail->hra, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Conveyance Allowance</td>
                                    <td class="text-end">₹ {{ number_format($detail->conveyance_allowance, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Medical Allowance</td>
                                    <td class="text-end">₹ {{ number_format($detail->medical_allowance, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Special Allowance</td>
                                    <td class="text-end">₹ {{ number_format($detail->special_allowance, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Other Allowance</td>
                                    <td class="text-end">₹ {{ number_format($detail->other_allowance, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Variable Allowance</td>
                                    <td class="text-end">₹ {{ number_format($detail->variable_allowance, 2) }}</td>
                                </tr>
                            </tbody>
                    ...
                    <div class="border rounded p-2">
                        ...
                        <table class="table table-sm table-borderless small mb-0">
                            <tbody>
                                <tr>
                                    <td>Employee PF</td>
                                    <td class="text-end">₹ {{ number_format($detail->employee_pf, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>ESI</td>
                                    <td class="text-end">₹ {{ number_format($detail->esi, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Professional Tax</td>
                                    <td class="text-end">₹ {{ number_format($detail->professional_tax, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>TDS</td>
                                    <td class="text-end">₹ {{ number_format($detail->tds, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Other Deduction</td>
                                    <td class="text-end">₹ {{ number_format($detail->other_deduction, 2) }}</td>
                                </tr>
                            </tbody>
                            <tfoot class="border-top fw-bold">
                                <tr>
                                    <td class="text-danger">Total Deduction</td>
